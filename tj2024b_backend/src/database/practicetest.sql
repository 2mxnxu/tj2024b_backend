...
insert into employees values (102,'lee', 'lee', 'asd@asd.asd', '2025-01-02', 'IT_PROG');
...
insert into products values (202,'keyboard', 'Electronics', 29.99, 150);
...
delete from employees where product_id = 201;
*/